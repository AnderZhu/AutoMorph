...
def process(train_list, test_list, save_path):
    ...
    for image_path in train_list:
        ...
        dst_image = PATH + 'train/' + image_path
    ...
    Data4stage2.to_csv('/content/drive/My Drive/Results/M0/crop_info.csv', index = None, encoding='utf8')
...
if __name__ == "__main__":
    ...
    train_list = sorted(os.listdir('/content/drive/My Drive/RFI-80GB/train'))
    test_list = sorted(os.listdir('/content/drive/My Drive/RFI-80GB/test'))
    
    save_path = '/content/drive/My Drive/Results/M0/images/'
